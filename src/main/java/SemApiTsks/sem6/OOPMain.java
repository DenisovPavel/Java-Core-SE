...
//        cats();
    ...
    private static void cats() {
      ...
      alwaysHungryCat alwaysHungryCat = new alwaysHungryCat("обжора");
        Plate bigPlate = new Plate(Integer.MAX_VALUE);
        alwaysHungryCat.eat(bigPlate);

        System.out.println(alwaysHungryCat.isHungry());


        Plate plate = new Plate(1_000_000);
        alwaysHungryCat.eat(plate);
        System.out.println(alwaysHungryCat.isHungry());
