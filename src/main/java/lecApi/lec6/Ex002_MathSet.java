...
public class Ex002_MathSet {
    public static void main(String[] args) {
        ...
        var r = new HashSet<Integer>(a); r.retainAll(b);// Возвращает элементы которые дублируются у 'R' and 'B'
        var s = new HashSet<Integer>(a); s.removeAll(b);// возвращает уникальные эле-ты которые недублируются в S & B
